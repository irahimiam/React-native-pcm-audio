...
RCT_EXPORT_METHOD(initializePCMRecorder:(NSDictionary *) options) {
    RCTLogInfo(@"init");
    ...
    _recordState.mDataFormat.mChannelsPerFrame  = options[@"channelConfig"] == nil ? 1 : [options[@"channelConfig"] unsignedIntValue];
    ...
    _recordState.bufferByteSize = 1024;
...
RCT_EXPORT_METHOD(startRecorder) {
    RCTLogInfo(@"start");
